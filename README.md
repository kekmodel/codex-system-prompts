...
**99,709 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
### `prompts/tool/` — 60 files, 14,222 tokens
...
| [`tool-spawn-agent-description-v2.md`](./prompts/tool/tool-spawn-agent-description-v2.md) | **241** | Inline ToolSpec description for `spawn_agent` (Pass 1.7, M9). |
| [`tool-spawn-agent-description.md`](./prompts/tool/tool-spawn-agent-description.md) | **831** | Inline ToolSpec description for `spawn_agent` (Pass 1.7, M9). |
