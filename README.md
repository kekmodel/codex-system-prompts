...
**126 captured files** across 11 categories — 
**99,987 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
### `prompts/tool/` — 37 files, 15,443 tokens
...
| [`tool-request-permissions.md`](./prompts/tool/tool-request-permissions.md) | **91** | `request_permissions` ToolSpec. |
| [`tool-request-user-input.md`](./prompts/tool/tool-request-user-input.md) | **212** | `request_user_input` ToolSpec. |
