...
**124 captured files** across 11 categories — 
**95,893 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
### `prompts/tool/` — 35 files, 10,406 tokens
