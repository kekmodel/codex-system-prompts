...
**101,234 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
### `prompts/tool/` — 39 files, 16,690 tokens
...
| [`tool-apply-patch.md`](./prompts/tool/tool-apply-patch.md) | **856** | `apply_patch` ToolSpec. |
| [`tool-close-agent-v2.md`](./prompts/tool/tool-close-agent-v2.md) | **124** | `close_agent` ToolSpec. |
| [`tool-close-agent.md`](./prompts/tool/tool-close-agent.md) | **120** | `close_agent` ToolSpec. |
...
| [`tool-create-goal.md`](./prompts/tool/tool-create-goal.md) | **188** | `create_goal` ToolSpec. |
| [`tool-exec-command-unix.md`](./prompts/tool/tool-exec-command-unix.md) | **311** | `exec_command` ToolSpec. |
| [`tool-exec-command-windows.md`](./prompts/tool/tool-exec-command-windows.md) | **315** | `exec_command` ToolSpec. |
| [`tool-followup-task.md`](./prompts/tool/tool-followup-task.md) | **160** | `followup_task` ToolSpec. |
| [`tool-get-goal.md`](./prompts/tool/tool-get-goal.md) | **72** | `get_goal` ToolSpec. |
| [`tool-list-agents.md`](./prompts/tool/tool-list-agents.md) | **110** | `list_agents` ToolSpec. |
| [`tool-list-dir.md`](./prompts/tool/tool-list-dir.md) | **190** | `list_dir` ToolSpec. |
| [`tool-list-mcp-resource-templates.md`](./prompts/tool/tool-list-mcp-resource-templates.md) | **172** | `list_mcp_resource_templates` ToolSpec. |
| [`tool-list-mcp-resources.md`](./prompts/tool/tool-list-mcp-resources.md) | **161** | `list_mcp_resources` ToolSpec. |
| [`tool-read-mcp-resource.md`](./prompts/tool/tool-read-mcp-resource.md) | **147** | `read_mcp_resource` ToolSpec. |
| [`tool-report-agent-job-result.md`](./prompts/tool/tool-report-agent-job-result.md) | **159** | `report_agent_job_result` ToolSpec. |
| [`tool-request-permissions.md`](./prompts/tool/tool-request-permissions.md) | **133** | `request_permissions` ToolSpec. |
| [`tool-request-user-input.md`](./prompts/tool/tool-request-user-input.md) | **226** | `request_user_input` ToolSpec. |
| [`tool-resume-agent.md`](./prompts/tool/tool-resume-agent.md) | **92** | `resume_agent` ToolSpec. |
| [`tool-send-input.md`](./prompts/tool/tool-send-input.md) | **197** | `send_input` ToolSpec. |
| [`tool-send-message.md`](./prompts/tool/tool-send-message.md) | **132** | `send_message` ToolSpec. |
| [`tool-shell-command-unix.md`](./prompts/tool/tool-shell-command-unix.md) | **206** | `shell_command` ToolSpec. |
| [`tool-shell-command-windows.md`](./prompts/tool/tool-shell-command-windows.md) | **345** | `shell_command` ToolSpec. |
| [`tool-shell-unix.md`](./prompts/tool/tool-shell-unix.md) | **174** | `shell` ToolSpec. |
| [`tool-shell-windows.md`](./prompts/tool/tool-shell-windows.md) | **379** | `shell` ToolSpec. |
...
| [`tool-spawn-agent-v2.md`](./prompts/tool/tool-spawn-agent-v2.md) | **313** | `spawn_agent` ToolSpec. |
| [`tool-spawn-agent.md`](./prompts/tool/tool-spawn-agent.md) | **878** | `spawn_agent` ToolSpec. |
| [`tool-spawn-agents-on-csv.md`](./prompts/tool/tool-spawn-agents-on-csv.md) | **374** | `spawn_agents_on_csv` ToolSpec. |
| [`tool-test-sync-tool.md`](./prompts/tool/tool-test-sync-tool.md) | **211** | `test_sync_tool` ToolSpec. |
| [`tool-tool-suggest.md`](./prompts/tool/tool-tool-suggest.md) | **657** | `tool_suggest` ToolSpec. |
| [`tool-update-goal.md`](./prompts/tool/tool-update-goal.md) | **160** | `update_goal` ToolSpec. |
| [`tool-update-plan.md`](./prompts/tool/tool-update-plan.md) | **118** | `update_plan` ToolSpec. |
| [`tool-view-image.md`](./prompts/tool/tool-view-image.md) | **191** | `view_image` ToolSpec. |
| [`tool-wait-agent-v2.md`](./prompts/tool/tool-wait-agent-v2.md) | **98** | `wait_agent` ToolSpec. |
| [`tool-wait-agent.md`](./prompts/tool/tool-wait-agent.md) | **94** | `wait_agent` ToolSpec. |
| [`tool-write-stdin.md`](./prompts/tool/tool-write-stdin.md) | **192** | `write_stdin` ToolSpec. |
