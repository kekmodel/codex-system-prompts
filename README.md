...
<!-- AUTO-GENERATED-START -->
_Auto-generated by `extractor pass5` (M6) at codex `rust-v0.129.0-alpha.1`._

**128 captured files** across 11 categories — 
**101,404 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
| File | Tokens | Description |
|---|---:|---|
| [`memory-read-read-path.md`](./prompts/memory/memory-read-read-path.md) | **1,532** | `codex-rs/memories/read/templates/memories/read_path.md` |
