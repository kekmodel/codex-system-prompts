...
<!-- AUTO-GENERATED-START -->
_Auto-generated by `extractor pass5` (M6) at codex `rust-v0.129.0-alpha.2`._

**129 captured files** across 11 categories — 
**101,656 tokens** (o200k_base, template counts — runtime values are placeholder-redacted, see SPEC §2.5 Layer A).
...
|---|---:|---|
| [`base-instructions-codex-auto-review.md`](./prompts/base-instructions/base-instructions-codex-auto-review.md) | **2,991** | `models.json` /models/.../base_instructions for slug `codex-auto-review` (json pointer `/models/5/base_instructions`). |
| [`base-instructions-default.md`](./prompts/base-instructions/base-instructions-default.md) | **4,371** | `codex-rs/protocol/src/prompts/base_instructions/default.md` |
| [`base-instructions-fallback.md`](./prompts/base-instructions/base-instructions-fallback.md) | **4,371** | `codex-rs/models-manager/prompt.md` |
| [`base-instructions-gpt-5.2.md`](./prompts/base-instructions/base-instructions-gpt-5.2.md) | **4,570** | `models.json` /models/.../base_instructions for slug `gpt-5.2` (json pointer `/models/4/base_instructions`). |
| [`base-instructions-gpt-5.3-codex.md`](./prompts/base-instructions/base-instructions-gpt-5.3-codex.md) | **2,551** | `models.json` /models/.../base_instructions for slug `gpt-5.3-codex` (json pointer `/models/3/base_instructions`). |
| [`base-instructions-gpt-5.4-mini.md`](./prompts/base-instructions/base-instructions-gpt-5.4-mini.md) | **2,639** | `models.json` /models/.../base_instructions for slug `gpt-5.4-mini` (json pointer `/models/2/base_instructions`). |
| [`base-instructions-gpt-5.4.md`](./prompts/base-instructions/base-instructions-gpt-5.4.md) | **2,991** | `models.json` /models/.../base_instructions for slug `gpt-5.4` (json pointer `/models/1/base_instructions`). |
| [`base-instructions-gpt-5.5.md`](./prompts/base-instructions/base-instructions-gpt-5.5.md) | **4,429** | `models.json` /models/.../base_instructions for slug `gpt-5.5` (json pointer `/models/0/base_instructions`). |
...
| File | Tokens | Description |
|---|---:|---|
| [`mode-collab-default.md`](./prompts/mode/mode-collab-default.md) | **173** | `codex-rs/collaboration-mode-templates/templates/default.md` |
| [`mode-collab-execute.md`](./prompts/mode/mode-collab-execute.md) | **763** | `codex-rs/collaboration-mode-templates/templates/execute.md` |
| [`mode-collab-pair-programming.md`](./prompts/mode/mode-collab-pair-programming.md) | **222** | `codex-rs/collaboration-mode-templates/templates/pair_programming.md` |
| [`mode-collab-plan.md`](./prompts/mode/mode-collab-plan.md) | **1,804** | `codex-rs/collaboration-mode-templates/templates/plan.md` |
| [`mode-compact-prompt.md`](./prompts/mode/mode-compact-prompt.md) | **89** | `codex-rs/core/templates/compact/prompt.md` |
| [`mode-compact-summary-prefix.md`](./prompts/mode/mode-compact-summary-prefix.md) | **77** | `codex-rs/core/templates/compact/summary_prefix.md` |
| [`mode-goal-budget-limit.md`](./prompts/mode/mode-goal-budget-limit.md) | **139** | `codex-rs/core/templates/goals/budget_limit.md` |
| [`mode-goal-continuation.md`](./prompts/mode/mode-goal-continuation.md) | **465** | `codex-rs/core/templates/goals/continuation.md` |
| [`mode-guardian-output-contract.md`](./prompts/mode/mode-guardian-output-contract.md) | **121** | `codex-rs/core/src/guardian/prompt.rs::guardian_output_contract_prompt` |
| [`mode-guardian-policy-template.md`](./prompts/mode/mode-guardian-policy-template.md) | **1,416** | `codex-rs/core/src/guardian/policy_template.md` |
| [`mode-guardian-policy.md`](./prompts/mode/mode-guardian-policy.md) | **1,042** | `codex-rs/core/src/guardian/policy.md` |
| [`mode-realtime-backend.md`](./prompts/mode/mode-realtime-backend.md) | **954** | `codex-rs/core/templates/realtime/backend_prompt.md` |
| [`mode-realtime-end.md`](./prompts/mode/mode-realtime-end.md) | **38** | `codex-rs/core/src/context/prompts/realtime/realtime_end.md` |
| [`mode-realtime-start.md`](./prompts/mode/mode-realtime-start.md) | **145** | `codex-rs/core/src/context/prompts/realtime/realtime_start.md` |
| [`mode-review-exit-interrupted.md`](./prompts/mode/mode-review-exit-interrupted.md) | **67** | `codex-rs/core/templates/review/exit_interrupted.xml` |
| [`mode-review-exit-success.md`](./prompts/mode/mode-review-exit-success.md) | **59** | `codex-rs/core/templates/review/exit_success.xml` |
| [`mode-review.md`](./prompts/mode/mode-review.md) | **1,370** | `codex-rs/core/review_prompt.md` |
...
| File | Tokens | Description |
|---|---:|---|
| [`permission-approval-never.md`](./prompts/permission/permission-approval-never.md) | **23** | `codex-rs/core/src/context/prompts/permissions/approval_policy/never.md` |
| [`permission-approval-on-failure.md`](./prompts/permission/permission-approval-on-failure.md) | **60** | `codex-rs/core/src/context/prompts/permissions/approval_policy/on_failure.md` |
| [`permission-approval-on-request-rule-request-permission.md`](./prompts/permission/permission-approval-on-request-rule-request-permission.md) | **333** | `codex-rs/core/src/context/prompts/permissions/approval_policy/on_request_rule_request_permission.md` |
| [`permission-approval-on-request.md`](./prompts/permission/permission-approval-on-request.md) | **758** | `codex-rs/core/src/context/prompts/permissions/approval_policy/on_request.md` |
| [`permission-approval-unless-trusted.md`](./prompts/permission/permission-approval-unless-trusted.md) | **50** | `codex-rs/core/src/context/prompts/permissions/approval_policy/unless_trusted.md` |
| [`permission-sandbox-danger-full-access.md`](./prompts/permission/permission-sandbox-danger-full-access.md) | **40** | `codex-rs/core/src/context/prompts/permissions/sandbox_mode/danger_full_access.md` |
| [`permission-sandbox-read-only.md`](./prompts/permission/permission-sandbox-read-only.md) | **36** | `codex-rs/core/src/context/prompts/permissions/sandbox_mode/read_only.md` |
| [`permission-sandbox-workspace-write.md`](./prompts/permission/permission-sandbox-workspace-write.md) | **57** | `codex-rs/core/src/context/prompts/permissions/sandbox_mode/workspace_write.md` |

### `prompts/context-fragment/` — 22 files, 361 tokens

ContextualUserFragment wrappers — XML-tagged user-message injections.

| File | Tokens | Description |
|---|---:|---|
| [`context-fragment-approved-command-prefix-saved.md`](./prompts/context-fragment/context-fragment-approved-command-prefix-saved.md) | **6** | `ApprovedCommandPrefixSaved` ContextualUserFragment. |
| [`context-fragment-apps-instructions.md`](./prompts/context-fragment/context-fragment-apps-instructions.md) | **143** | `AppsInstructions` ContextualUserFragment. |
| [`context-fragment-available-plugins-instructions.md`](./prompts/context-fragment/context-fragment-available-plugins-instructions.md) | **0** | `AvailablePluginsInstructions` ContextualUserFragment. |
| [`context-fragment-available-skills-instructions.md`](./prompts/context-fragment/context-fragment-available-skills-instructions.md) | **0** | `AvailableSkillsInstructions` ContextualUserFragment. |
| [`context-fragment-collaboration-mode-instructions.md`](./prompts/context-fragment/context-fragment-collaboration-mode-instructions.md) | **0** | `CollaborationModeInstructions` ContextualUserFragment. |
| [`context-fragment-environment-context.md`](./prompts/context-fragment/context-fragment-environment-context.md) | **0** | `EnvironmentContext` ContextualUserFragment. |
| [`context-fragment-guardian-followup-review-reminder.md`](./prompts/context-fragment/context-fragment-guardian-followup-review-reminder.md) | **0** | `GuardianFollowupReviewReminder` ContextualUserFragment. |
| [`context-fragment-hook-additional-context.md`](./prompts/context-fragment/context-fragment-hook-additional-context.md) | **0** | `HookAdditionalContext` ContextualUserFragment. |
| [`context-fragment-image-generation-instructions.md`](./prompts/context-fragment/context-fragment-image-generation-instructions.md) | **41** | `ImageGenerationInstructions` ContextualUserFragment. |
| [`context-fragment-model-switch-instructions.md`](./prompts/context-fragment/context-fragment-model-switch-instructions.md) | **28** | `ModelSwitchInstructions` ContextualUserFragment. |
| [`context-fragment-network-rule-saved.md`](./prompts/context-fragment/context-fragment-network-rule-saved.md) | **0** | `NetworkRuleSaved` ContextualUserFragment. |
| [`context-fragment-permissions-instructions.md`](./prompts/context-fragment/context-fragment-permissions-instructions.md) | **8** | `PermissionsInstructions` ContextualUserFragment. |
| [`context-fragment-personality-spec-instructions.md`](./prompts/context-fragment/context-fragment-personality-spec-instructions.md) | **31** | `PersonalitySpecInstructions` ContextualUserFragment. |
| [`context-fragment-plugin-instructions.md`](./prompts/context-fragment/context-fragment-plugin-instructions.md) | **0** | `PluginInstructions` ContextualUserFragment. |
| [`context-fragment-realtime-end-instructions.md`](./prompts/context-fragment/context-fragment-realtime-end-instructions.md) | **5** | `RealtimeEndInstructions` ContextualUserFragment. |
| [`context-fragment-realtime-start-instructions.md`](./prompts/context-fragment/context-fragment-realtime-start-instructions.md) | **2** | `RealtimeStartInstructions` ContextualUserFragment. |
| [`context-fragment-realtime-start-with-instructions.md`](./prompts/context-fragment/context-fragment-realtime-start-with-instructions.md) | **2** | `RealtimeStartWithInstructions` ContextualUserFragment. |
| [`context-fragment-skill-instructions.md`](./prompts/context-fragment/context-fragment-skill-instructions.md) | **19** | `SkillInstructions` ContextualUserFragment. |
| [`context-fragment-subagent-notification.md`](./prompts/context-fragment/context-fragment-subagent-notification.md) | **11** | `SubagentNotification` ContextualUserFragment. |
| [`context-fragment-turn-aborted.md`](./prompts/context-fragment/context-fragment-turn-aborted.md) | **11** | `TurnAborted` ContextualUserFragment. |
| [`context-fragment-user-instructions.md`](./prompts/context-fragment/context-fragment-user-instructions.md) | **17** | `UserInstructions` ContextualUserFragment. |
| [`context-fragment-user-shell-command.md`](./prompts/context-fragment/context-fragment-user-shell-command.md) | **37** | `UserShellCommand` ContextualUserFragment. |

### `prompts/tool/` — 39 files, 16,860 tokens

Built-in tool descriptions (apply_patch, spawn_agent guidance, MCP message templates).

| File | Tokens | Description |
|---|---:|---|
| [`tool-apply-patch-instructions.md`](./prompts/tool/tool-apply-patch-instructions.md) | **752** | `codex-rs/apply-patch/apply_patch_tool_instructions.md` |
| [`tool-apply-patch-json-description.md`](./prompts/tool/tool-apply-patch-json-description.md) | **706** | `codex-rs/tools/src/apply_patch_tool.rs::APPLY_PATCH_JSON_TOOL_DESCRIPTION` |
| [`tool-apply-patch.md`](./prompts/tool/tool-apply-patch.md) | **861** | `apply_patch` ToolSpec. |
| [`tool-close-agent-v2.md`](./prompts/tool/tool-close-agent-v2.md) | **129** | `close_agent` ToolSpec. |
| [`tool-close-agent.md`](./prompts/tool/tool-close-agent.md) | **125** | `close_agent` ToolSpec. |
| [`tool-consequential-message-templates.md`](./prompts/tool/tool-consequential-message-templates.md) | **6,900** | `codex-rs/core/src/consequential_tool_message_templates.json` |
| [`tool-create-goal.md`](./prompts/tool/tool-create-goal.md) | **193** | `create_goal` ToolSpec. |
| [`tool-exec-command-unix.md`](./prompts/tool/tool-exec-command-unix.md) | **316** | `exec_command` ToolSpec. |
| [`tool-exec-command-windows.md`](./prompts/tool/tool-exec-command-windows.md) | **320** | `exec_command` ToolSpec. |
| [`tool-followup-task.md`](./prompts/tool/tool-followup-task.md) | **165** | `followup_task` ToolSpec. |
| [`tool-get-goal.md`](./prompts/tool/tool-get-goal.md) | **77** | `get_goal` ToolSpec. |
| [`tool-list-agents.md`](./prompts/tool/tool-list-agents.md) | **115** | `list_agents` ToolSpec. |
| [`tool-list-dir.md`](./prompts/tool/tool-list-dir.md) | **195** | `list_dir` ToolSpec. |
| [`tool-list-mcp-resource-templates.md`](./prompts/tool/tool-list-mcp-resource-templates.md) | **177** | `list_mcp_resource_templates` ToolSpec. |
| [`tool-list-mcp-resources.md`](./prompts/tool/tool-list-mcp-resources.md) | **166** | `list_mcp_resources` ToolSpec. |
| [`tool-read-mcp-resource.md`](./prompts/tool/tool-read-mcp-resource.md) | **152** | `read_mcp_resource` ToolSpec. |
| [`tool-report-agent-job-result.md`](./prompts/tool/tool-report-agent-job-result.md) | **164** | `report_agent_job_result` ToolSpec. |
| [`tool-request-permissions.md`](./prompts/tool/tool-request-permissions.md) | **138** | `request_permissions` ToolSpec. |
| [`tool-request-user-input.md`](./prompts/tool/tool-request-user-input.md) | **231** | `request_user_input` ToolSpec. |
| [`tool-resume-agent.md`](./prompts/tool/tool-resume-agent.md) | **97** | `resume_agent` ToolSpec. |
| [`tool-send-input.md`](./prompts/tool/tool-send-input.md) | **202** | `send_input` ToolSpec. |
| [`tool-send-message.md`](./prompts/tool/tool-send-message.md) | **137** | `send_message` ToolSpec. |
| [`tool-shell-command-unix.md`](./prompts/tool/tool-shell-command-unix.md) | **211** | `shell_command` ToolSpec. |
| [`tool-shell-command-windows.md`](./prompts/tool/tool-shell-command-windows.md) | **350** | `shell_command` ToolSpec. |
| [`tool-shell-unix.md`](./prompts/tool/tool-shell-unix.md) | **179** | `shell` ToolSpec. |
| [`tool-shell-windows.md`](./prompts/tool/tool-shell-windows.md) | **384** | `shell` ToolSpec. |
| [`tool-spawn-agent-inherited-model-guidance.md`](./prompts/tool/tool-spawn-agent-inherited-model-guidance.md) | **33** | `codex-rs/tools/src/agent_tool.rs::SPAWN_AGENT_INHERITED_MODEL_GUIDANCE` |
| [`tool-spawn-agent-model-override-description.md`](./prompts/tool/tool-spawn-agent-model-override-description.md) | **44** | `codex-rs/tools/src/agent_tool.rs::SPAWN_AGENT_MODEL_OVERRIDE_DESCRIPTION` |
| [`tool-spawn-agent-v2.md`](./prompts/tool/tool-spawn-agent-v2.md) | **318** | `spawn_agent` ToolSpec. |
| [`tool-spawn-agent.md`](./prompts/tool/tool-spawn-agent.md) | **883** | `spawn_agent` ToolSpec. |
| [`tool-spawn-agents-on-csv.md`](./prompts/tool/tool-spawn-agents-on-csv.md) | **379** | `spawn_agents_on_csv` ToolSpec. |
| [`tool-test-sync-tool.md`](./prompts/tool/tool-test-sync-tool.md) | **216** | `test_sync_tool` ToolSpec. |
| [`tool-tool-suggest.md`](./prompts/tool/tool-tool-suggest.md) | **662** | `tool_suggest` ToolSpec. |
| [`tool-update-goal.md`](./prompts/tool/tool-update-goal.md) | **165** | `update_goal` ToolSpec. |
| [`tool-update-plan.md`](./prompts/tool/tool-update-plan.md) | **123** | `update_plan` ToolSpec. |
| [`tool-view-image.md`](./prompts/tool/tool-view-image.md) | **196** | `view_image` ToolSpec. |
| [`tool-wait-agent-v2.md`](./prompts/tool/tool-wait-agent-v2.md) | **103** | `wait_agent` ToolSpec. |
| [`tool-wait-agent.md`](./prompts/tool/tool-wait-agent.md) | **99** | `wait_agent` ToolSpec. |
| [`tool-write-stdin.md`](./prompts/tool/tool-write-stdin.md) | **197** | `write_stdin` ToolSpec. |
...
| File | Tokens | Description |
|---|---:|---|
| [`agent-builtin-awaiter.md`](./prompts/agent/agent-builtin-awaiter.md) | **259** | `codex-rs/core/src/agent/builtins/awaiter.toml` |
| [`agent-hierarchical-message.md`](./prompts/agent/agent-hierarchical-message.md) | **209** | `codex-rs/core/hierarchical_agents_message.md` |
| [`agent-role-explorer.md`](./prompts/agent/agent-role-explorer.md) | **188** | `codex-rs/core/src/agent/role.rs` |
| [`agent-role-worker.md`](./prompts/agent/agent-role-worker.md) | **196** | `codex-rs/core/src/agent/role.rs` |

### `prompts/memory/` — 5 files, 18,309 tokens

/memories skill prompts.

| File | Tokens | Description |
|---|---:|---|
| [`memory-read-read-path.md`](./prompts/memory/memory-read-read-path.md) | **1,633** | `codex-rs/memories/read/templates/memories/read_path.md` |
| [`memory-write-consolidation.md`](./prompts/memory/memory-write-consolidation.md) | **10,379** | `codex-rs/memories/write/templates/memories/consolidation.md` |
| [`memory-write-instructions.md`](./prompts/memory/memory-write-instructions.md) | **151** | `codex-rs/memories/write/templates/extensions/ad_hoc/instructions.md` |
| [`memory-write-stage-one-input.md`](./prompts/memory/memory-write-stage-one-input.md) | **86** | `codex-rs/memories/write/templates/memories/stage_one_input.md` |
| [`memory-write-stage-one-system.md`](./prompts/memory/memory-write-stage-one-system.md) | **6,060** | `codex-rs/memories/write/templates/memories/stage_one_system.md` |
...
| File | Tokens | Description |
|---|---:|---|
| [`code-mode-deferred-nested-tools-guidance.md`](./prompts/code-mode/code-mode-deferred-nested-tools-guidance.md) | **76** | `codex-rs/code-mode/src/description.rs::DEFERRED_NESTED_TOOLS_GUIDANCE` |
| [`code-mode-exec-description-template.md`](./prompts/code-mode/code-mode-exec-description-template.md) | **700** | `codex-rs/code-mode/src/description.rs::EXEC_DESCRIPTION_TEMPLATE` |
| [`code-mode-mcp-typescript-preamble.md`](./prompts/code-mode/code-mode-mcp-typescript-preamble.md) | **413** | `codex-rs/code-mode/src/description.rs::MCP_TYPESCRIPT_PREAMBLE` |
| [`code-mode-only-preface.md`](./prompts/code-mode/code-mode-only-preface.md) | **76** | `codex-rs/code-mode/src/description.rs::CODE_MODE_ONLY_PREFACE` |
| [`code-mode-wait-description-template.md`](./prompts/code-mode/code-mode-wait-description-template.md) | **162** | `codex-rs/code-mode/src/description.rs::WAIT_DESCRIPTION_TEMPLATE` |
...
| File | Tokens | Description |
|---|---:|---|
| [`tui-init-command.md`](./prompts/tui/tui-init-command.md) | **322** | `codex-rs/tui/prompt_for_init_command.md` |
...
| File | Tokens | Description |
|---|---:|---|
| [`data-agent-names.md`](./prompts/data/data-agent-names.md) | **340** | `codex-rs/core/src/agent/agent_names.txt` |
| [`data-apply-patch-grammar.md`](./prompts/data/data-apply-patch-grammar.md) | **173** | `codex-rs/tools/src/tool_apply_patch.lark` |
...
| File | Tokens | Description |
|---|---:|---|
| [`orphan-core-gpt-5-1-codex-max-prompt.md`](./prompts/orphan/orphan-core-gpt-5-1-codex-max-prompt.md) | **1,624** | Orphan: `codex-rs/core/gpt-5.1-codex-max_prompt.md` (not `include_str!`'d). |
| [`orphan-core-gpt-5-1-prompt.md`](./prompts/orphan/orphan-core-gpt-5-1-prompt.md) | **5,076** | Orphan: `codex-rs/core/gpt_5_1_prompt.md` (not `include_str!`'d). |
| [`orphan-core-gpt-5-2-codex-prompt.md`](./prompts/orphan/orphan-core-gpt-5-2-codex-prompt.md) | **1,624** | Orphan: `codex-rs/core/gpt-5.2-codex_prompt.md` (not `include_str!`'d). |
| [`orphan-core-gpt-5-2-prompt.md`](./prompts/orphan/orphan-core-gpt-5-2-prompt.md) | **4,570** | Orphan: `codex-rs/core/gpt_5_2_prompt.md` (not `include_str!`'d). |
| [`orphan-core-gpt-5-codex-prompt.md`](./prompts/orphan/orphan-core-gpt-5-codex-prompt.md) | **1,436** | Orphan: `codex-rs/core/gpt_5_codex_prompt.md` (not `include_str!`'d). |
| [`orphan-core-prompt-with-apply-patch-instructions.md`](./prompts/orphan/orphan-core-prompt-with-apply-patch-instructions.md) | **5,123** | Orphan: `codex-rs/core/prompt_with_apply_patch_instructions.md` (not `include_str!`'d). |
| [`orphan-core-templates-agents-orchestrator.md`](./prompts/orphan/orphan-core-templates-agents-orchestrator.md) | **1,037** | Orphan: `codex-rs/core/templates/agents/orchestrator.md` (not `include_str!`'d). |
| [`orphan-core-templates-collab-experimental-prompt.md`](./prompts/orphan/orphan-core-templates-collab-experimental-prompt.md) | **291** | Orphan: `codex-rs/core/templates/collab/experimental_prompt.md` (not `include_str!`'d). |
| [`orphan-core-templates-model-instructions-gpt-5-2-codex-instructions-template.md`](./prompts/orphan/orphan-core-templates-model-instructions-gpt-5-2-codex-instructions-template.md) | **1,573** | Orphan: `codex-rs/core/templates/model_instructions/gpt-5.2-codex_instructions_template.md` (not `include_str!`'d). |
| [`orphan-core-templates-personalities-gpt-5-2-codex-friendly.md`](./prompts/orphan/orphan-core-templates-personalities-gpt-5-2-codex-friendly.md) | **378** | Orphan: `codex-rs/core/templates/personalities/gpt-5.2-codex_friendly.md` (not `include_str!`'d). |
| [`orphan-core-templates-personalities-gpt-5-2-codex-pragmatic.md`](./prompts/orphan/orphan-core-templates-personalities-gpt-5-2-codex-pragmatic.md) | **335** | Orphan: `codex-rs/core/templates/personalities/gpt-5.2-codex_pragmatic.md` (not `include_str!`'d). |
| [`orphan-core-templates-review-history-message-completed.md`](./prompts/orphan/orphan-core-templates-review-history-message-completed.md) | **59** | Orphan: `codex-rs/core/templates/review/history_message_completed.md` (not `include_str!`'d). |
| [`orphan-core-templates-review-history-message-interrupted.md`](./prompts/orphan/orphan-core-templates-review-history-message-interrupted.md) | **67** | Orphan: `codex-rs/core/templates/review/history_message_interrupted.md` (not `include_str!`'d). |
| [`orphan-core-templates-search-tool-tool-description.md`](./prompts/orphan/orphan-core-templates-search-tool-tool-description.md) | **119** | Orphan: `codex-rs/core/templates/search_tool/tool_description.md` (not `include_str!`'d). |
| [`orphan-core-templates-search-tool-tool-suggest-description.md`](./prompts/orphan/orphan-core-templates-search-tool-tool-suggest-description.md) | **430** | Orphan: `codex-rs/core/templates/search_tool/tool_suggest_description.md` (not `include_str!`'d). |
| [`orphan-models-manager-default-personality-header.md`](./prompts/orphan/orphan-models-manager-default-personality-header.md) | **30** | `codex-rs/models-manager/src/model_info.rs::DEFAULT_PERSONALITY_HEADER` |
| [`orphan-models-manager-local-friendly-template.md`](./prompts/orphan/orphan-models-manager-local-friendly-template.md) | **16** | `codex-rs/models-manager/src/model_info.rs::LOCAL_FRIENDLY_TEMPLATE` |
| [`orphan-models-manager-local-pragmatic-template.md`](./prompts/orphan/orphan-models-manager-local-pragmatic-template.md) | **10** | `codex-rs/models-manager/src/model_info.rs::LOCAL_PRAGMATIC_TEMPLATE` |
