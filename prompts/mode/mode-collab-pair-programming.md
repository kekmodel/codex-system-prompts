---
name: 'Mode: mode-collab-pair-programming'
category: mode
codex_version: rust-v0.126.0-alpha.12
codex_commit: ebdf3a878c8c7253504599bd384cd421a4e548c1
source:
  path: codex-rs/collaboration-mode-templates/templates/pair_programming.md
  kind: include_str
  reached_from:
  - collaboration-mode-templates/src/lib.rs:4
extraction:
  pass: 1
  method: file
variables: []
tokens:
  o200k_base: 222
description: 'Auto-extracted by Pass 3 (M2) from `codex-rs/collaboration-mode-templates/templates/pair_programming.md`.
