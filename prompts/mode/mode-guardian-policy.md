---
name: 'Mode: mode-guardian-policy'
category: mode
codex_version: rust-v0.126.0-alpha.12
codex_commit: ebdf3a878c8c7253504599bd384cd421a4e548c1
source:
  path: codex-rs/core/src/guardian/policy.md
  kind: include_str
  reached_from:
  - core/src/guardian/prompt.rs:640
extraction:
  pass: 1
  method: file
variables: []
tokens:
  o200k_base: 1042
description: 'Auto-extracted by Pass 3 (M2) from `codex-rs/core/src/guardian/policy.md`.
