---
name: 'Mode: mode-collab-execute'
category: mode
codex_version: rust-v0.126.0-alpha.12
codex_commit: ebdf3a878c8c7253504599bd384cd421a4e548c1
source:
  path: codex-rs/collaboration-mode-templates/templates/execute.md
  kind: include_str
  reached_from:
  - collaboration-mode-templates/src/lib.rs:3
extraction:
  pass: 1
  method: file
variables: []
tokens:
  o200k_base: 763
description: 'Auto-extracted by Pass 3 (M2) from `codex-rs/collaboration-mode-templates/templates/execute.md`.
