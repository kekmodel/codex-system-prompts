---
name: 'Base-instructions: base-instructions-fallback'
...
source:
  ...
  kind: include_str
  reached_from:
  - models-manager/src/model_info.rs:16
extraction:
  pass: 1
  method: file
variables: []
tokens:
  o200k_base: 4371
description: 'Auto-extracted by Pass 3 (M2) from `codex-rs/models-manager/prompt.md`.
