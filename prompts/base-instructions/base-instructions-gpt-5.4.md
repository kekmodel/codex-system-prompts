---
name: 'Base instructions: gpt-5.4'
...
source:
  ...
  kind: json_field
  json_pointer: /models/1/base_instructions
extraction:
  pass: 1
  method: json_field
variables: []
tokens:
  o200k_base: 2991
description: 'Per-model `base_instructions` for slug `gpt-5.4`, fanned out from `codex-rs/models-manager/models.json`
  per SPEC §2.4. JSON pointer: /models/1/base_instructions.'
---
