---
name: 'Tool: tool-consequential-message-templates'
category: tool
codex_version: rust-v0.126.0-alpha.12
codex_commit: ebdf3a878c8c7253504599bd384cd421a4e548c1
source:
  path: codex-rs/core/src/consequential_tool_message_templates.json
  kind: include_str
  reached_from:
  - core/src/mcp_tool_approval_templates.rs:73
extraction:
  pass: 1
  method: file
variables: []
