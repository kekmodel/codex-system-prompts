...
tokens:
  o200k_base: 333
description: Inline ToolSpec description for `shell` resolved from a `let description
  = …` binding (sub-kind `cfg_conditional`). Pass 1.7 (M9).
---
